...
#print(soup.text);
urlStr1 = "https://timesofindia.indiatimes.com/2018/6/28/archivelist/year-2018,month-6,starttime-43279.cms"
...
news_data_txt = open('C:/Users/khushal/Documents/Python Scripts//news.txt', 'r',encoding="utf-8").readlines()
positive = 0
negative = 0
neutral = 0
polarity = 0
